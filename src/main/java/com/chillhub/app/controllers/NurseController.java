...
public class NurseController {
	...
	public void addQueuer(@PathVariable("nid") int nurseId, @PathVariable("aid") int appointmentId, @RequestBody Queuer queuer) throws CustomApiException {
		if(!nurseService.getOneById(nurseId).isPresent()) {
			throw new CustomApiException("nurse with id " + nurseId + " is not found !!!");
		}
	...
	public void updateQueuerStatus(@PathVariable("nid") int nurseId, @PathVariable("qid") int queuerId, @RequestBody Queuer queuer) throws CustomApiException {
		if(!nurseService.getOneById(nurseId).isPresent()) {
			throw new CustomApiException("nurse with id " + nurseId + " is not found !!!");
		}
